...
import flight5 from "../assets/flight_takeoff_5.svg";
...
const SeeMore = () => {
  return (
    <section className='about-bottom-banner py-28 flex px-4 relative'>
        ...
        <img src={checkmark} alt="" className='absolute top-20 left-[280px] w-[6rem] md:w-[8rem] xl:w-[10rem] hidden lg:block'/>
        <img src={flight1} alt="" className='absolute bottom-0 left-[410px] w-[6rem] hidden lg:block'/>
        <img src={flight2} alt="" className='absolute bottom-16 right-[300px] w-[5.5rem] hidden lg:block'/>
        <img src={flight3} alt="" className='absolute top-[300px] right-[220px] w-[7rem] hidden lg:block'/>
        <img src={flight4} alt="" className='absolute top-[320px] left-[128px] w-[7rem] hidden lg:block'/>
        <img src={flight5} alt="" className='absolute top-[90px] right-[360px] w-[5rem] hidden lg:block'/>
    </section>
  )
}
