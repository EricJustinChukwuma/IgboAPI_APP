...
import supportImage from "../assets/image 1.svg";
import Bachelorette from "../assets/Bachelorette party-amico 1.svg";

const Support = () => {
    
  return (
    <>
        <section className='w-full pt-20 pb-24 bg-blue-600 relative overflow-hidden'>
            ...
            <img src={Bachelorette} alt="" className='w-[100%] h-[22rem] absolute top-0 right-0 hidden md:block'/>
