      ...
      <>
          <section className='w-full bg-[#81ca7a] py-48 overflow-hidden relative'>   
              ...
              <div className='w-full md:w-[600px] flex flex-col justify-start items-start relative px-4 md:px-8'>
                  ...
                  <p className='text-sm md:text-lg leading-8 md:leading-10 text-gray-300'>The Igbo API is a multidialectal audio-supported, open-to-contribute Igbo-English dictionary API. This Project focuses on enabling developers, organizations, and teams to create technology that relies  on the Igbo language.</p>
              </div>
